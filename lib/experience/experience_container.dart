  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          new InkWell(
              child: new Text(experience.company.getTitle),
              onTap: () =>
                  html.window.open(experience.company.getLink, "_blank")),
          SizedBox(height: 10),
          Text(
            experience.timeLine,
...
class CompanyLink {
  ...
  CompanyLink(this.link, this.title);
...
final experiences = [
  ExperienceInfo(
    company: new CompanyLink('https://www.dstech.it/', 'Ds Tech '),
  ...
  ExperienceInfo(
    company: new CompanyLink('https://www.welld.ch/', 'Welld'),
  ...
  ExperienceInfo(
    company: new CompanyLink('https://edrtools.eu/', 'EDR Tools'),
